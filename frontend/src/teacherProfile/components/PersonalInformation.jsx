          ...
          <form action="">
            ...
            <div className="combo_box">
              ...
              <div className="input_box">
                ...
                <div className="input">
                  <input type="text" placeholder="Your hourly fee" />
                </div>
              </div>
            </div>
            <div className="combo_box">
            ...
            <div className="option">
              ...
              <div className="combo_box">
                <div onClick={() => handleDivClick("myHome")} className={checkBoxData.myHome ? "checked" : ""}>
                  <input
                    type="checkbox"
                    checked={checkBoxData.myHome}
                    onChange={() => handleDivClick("myHome")} // Keeps the checkbox functional
                  />
                  <label htmlFor="myHome">My home</label>
                </div>

                <div onClick={() => handleDivClick("studentHome")} className={checkBoxData.studentHome ? "checked" : ""}>
                  <input
                    type="checkbox"
                    checked={checkBoxData.studentHome}
                    onChange={() => handleDivClick("studentHome")} // Keeps the checkbox functional
                  />
                  <label htmlFor="studentHome">Student home</label>
                </div>

                <div onClick={() => handleDivClick("online")} className={checkBoxData.online ? "checked" : ""}>
                  <input
                    type="checkbox"
                    checked={checkBoxData.online}
